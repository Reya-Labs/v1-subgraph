const getUnderlyingTokenName = (address: string): string => {
  ...
  // arbitrum
  if (address.toLowerCase().includes('0xFF970A61A04b1cA14834A43f5dE4533eBDDB5CC8'.toLowerCase())) {
    return 'USDC';
  }
  // arbitrumGoerli
  ...
  // goerli 2
  if (address.toLowerCase().includes('0xdc31Ee1784292379Fbb2964b3B9C4124D8F89C60'.toLowerCase())) {
    return 'DAI';
  }
  // arbitrum
  if (address.toLowerCase().includes('0xda10009cbd5d07dd0cecc66161fc93d7c9000da1'.toLowerCase())) {
    return 'DAI';
  }
  // arbitrumGoerli
  if (address.toLowerCase().includes('0xf556C102F47d806E21E8E78438E58ac06A14A29E'.toLowerCase())) {
    return 'DAI';
  }
  ...
  // arbitrum
  if (address.toLowerCase().includes('0x82aF49447D8a07e3bd95BD0d56f35241523fBab1'.toLowerCase())) {
    return 'ETH';
  }
  // arbitrumGoerli
  if (address.toLowerCase().includes('0xb83C277172198E8Ec6b841Ff9bEF2d7fa524f797'.toLowerCase())) {
    return 'ETH';
  }

  // ====== USDT ======
  // mainnet
  if (address.toLowerCase().includes('0xdAC17F958D2ee523a2206206994597C13D831ec7'.toLowerCase())) {
    return 'USDT';
  }
  // goerli
  if (address.toLowerCase().includes('0x79C950C7446B234a6Ad53B908fBF342b01c4d446'.toLowerCase())) {
    return 'USDT';
  }
  // arbitrum
  if (address.toLowerCase().includes('0xFd086bC7CD5C481DCC9C85ebE478A1C0b69FCbb9'.toLowerCase())) {
    return 'USDT';
  }
  // arbitrumGoerli
