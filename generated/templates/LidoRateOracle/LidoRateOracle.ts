...
export class LidoRateOracle__observationsResult {
  value0: BigInt;
  value1: BigInt;
  value2: boolean;
...
export class LidoRateOracle__oracleVarsResult {
  value0: i32;
  value1: i32;
  value2: i32;
...
export class LidoRateOracle extends ethereum.SmartContract {
  static bind(address: Address): LidoRateOracle {
    return new LidoRateOracle("LidoRateOracle", address);
  }
  ...
  RATE_VALUE_UPDATE_EPSILON(): BigInt {
    let result = super.call(
      "RATE_VALUE_UPDATE_EPSILON",
      "RATE_VALUE_UPDATE_EPSILON():(uint256)",
      []
    );
  ...
  try_RATE_VALUE_UPDATE_EPSILON(): ethereum.CallResult<BigInt> {
  ...
  lidoOracle(): Address {
    let result = super.call("lidoOracle", "lidoOracle():(address)", []);

    return result[0].toAddress();
  }

  try_lidoOracle(): ethereum.CallResult<Address> {
    let result = super.tryCall("lidoOracle", "lidoOracle():(address)", []);
    if (result.reverted) {
      return new ethereum.CallResult();
    }
    let value = result.value;
  ...
  observations(param0: BigInt): LidoRateOracle__observationsResult {
    let result = super.call(
      "observations",
    ...
    return new LidoRateOracle__observationsResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBoolean()
    );
  ...
  try_observations(
    param0: BigInt
  ): ethereum.CallResult<LidoRateOracle__observationsResult> {
    let result = super.tryCall(
      "observations",
      "observations(uint256):(uint32,uint216,bool)",
      [ethereum.Value.fromUnsignedBigInt(param0)]
    ...
    return ethereum.CallResult.fromValue(
      new LidoRateOracle__observationsResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBoolean()
      )
  ...
  oracleVars(): LidoRateOracle__oracleVarsResult {
    let result = super.call(
      "oracleVars",
    ...
    return new LidoRateOracle__oracleVarsResult(
      result[0].toI32(),
      result[1].toI32(),
      result[2].toI32()
    );
  ...
  try_oracleVars(): ethereum.CallResult<LidoRateOracle__oracleVarsResult> {
    let result = super.tryCall(
      "oracleVars",
      "oracleVars():(uint16,uint16,uint16)",
      []
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new LidoRateOracle__oracleVarsResult(
        value[0].toI32(),
        value[1].toI32(),
        value[2].toI32()
      )
