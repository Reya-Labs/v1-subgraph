...
export class RocketPoolRateOracle__observationsResult {
  value0: BigInt;
  value1: BigInt;
  value2: boolean;
...
export class RocketPoolRateOracle__oracleVarsResult {
  value0: i32;
  value1: i32;
  value2: i32;
...
export class RocketPoolRateOracle extends ethereum.SmartContract {
  static bind(address: Address): RocketPoolRateOracle {
    return new RocketPoolRateOracle("RocketPoolRateOracle", address);
  }
  ...
  observations(param0: BigInt): RocketPoolRateOracle__observationsResult {
    let result = super.call(
      "observations",
    ...
    return new RocketPoolRateOracle__observationsResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBoolean()
    );
  ...
  try_observations(
    param0: BigInt
  ): ethereum.CallResult<RocketPoolRateOracle__observationsResult> {
    let result = super.tryCall(
      "observations",
      "observations(uint256):(uint32,uint216,bool)",
      [ethereum.Value.fromUnsignedBigInt(param0)]
    ...
    return ethereum.CallResult.fromValue(
      new RocketPoolRateOracle__observationsResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBoolean()
      )
  ...
  oracleVars(): RocketPoolRateOracle__oracleVarsResult {
    let result = super.call(
      "oracleVars",
    ...
    return new RocketPoolRateOracle__oracleVarsResult(
      result[0].toI32(),
      result[1].toI32(),
      result[2].toI32()
    );
  ...
  try_oracleVars(): ethereum.CallResult<
    RocketPoolRateOracle__oracleVarsResult
  > {
    let result = super.tryCall(
      "oracleVars",
      "oracleVars():(uint16,uint16,uint16)",
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new RocketPoolRateOracle__oracleVarsResult(
        value[0].toI32(),
        value[1].toI32(),
        value[2].toI32()
      )
  ...
  rocketEth(): Address {
    let result = super.call("rocketEth", "rocketEth():(address)", []);

    return result[0].toAddress();
  }

  try_rocketEth(): ethereum.CallResult<Address> {
    let result = super.tryCall("rocketEth", "rocketEth():(address)", []);
    if (result.reverted) {
      return new ethereum.CallResult();
    }
    let value = result.value;
