...
export class CompoundRateOracle_cDAI__observationsResult {
  value0: BigInt;
  value1: BigInt;
  value2: boolean;
...
export class CompoundRateOracle_cDAI__oracleVarsResult {
  value0: i32;
  value1: i32;
  value2: i32;
...
export class CompoundRateOracle_cDAI extends ethereum.SmartContract {
  static bind(address: Address): CompoundRateOracle_cDAI {
    return new CompoundRateOracle_cDAI("CompoundRateOracle_cDAI", address);
  }
  ...
  observations(param0: BigInt): CompoundRateOracle_cDAI__observationsResult {
    let result = super.call(
      "observations",
    ...
    return new CompoundRateOracle_cDAI__observationsResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBoolean()
    );
  ...
  try_observations(
    param0: BigInt
  ): ethereum.CallResult<CompoundRateOracle_cDAI__observationsResult> {
    let result = super.tryCall(
      "observations",
      "observations(uint256):(uint32,uint216,bool)",
      [ethereum.Value.fromUnsignedBigInt(param0)]
    ...
    return ethereum.CallResult.fromValue(
      new CompoundRateOracle_cDAI__observationsResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBoolean()
      )
  ...
  oracleVars(): CompoundRateOracle_cDAI__oracleVarsResult {
    let result = super.call(
      "oracleVars",
    ...
    return new CompoundRateOracle_cDAI__oracleVarsResult(
      result[0].toI32(),
      result[1].toI32(),
      result[2].toI32()
    );
  ...
  try_oracleVars(): ethereum.CallResult<
    CompoundRateOracle_cDAI__oracleVarsResult
  > {
    let result = super.tryCall(
      "oracleVars",
      "oracleVars():(uint16,uint16,uint16)",
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new CompoundRateOracle_cDAI__oracleVarsResult(
        value[0].toI32(),
        value[1].toI32(),
        value[2].toI32()
      )
