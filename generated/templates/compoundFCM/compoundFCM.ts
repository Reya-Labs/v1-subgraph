...
export class compoundFCM__getTraderWithYieldBearingAssetsResultTraderInfoStruct extends ethereum.Tuple {
  get marginInScaledYieldBearingTokens(): BigInt {
...
export class compoundFCM__initiateFullyCollateralisedFixedTakerSwapResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
  value3: BigInt;
...
export class compoundFCM__tradersResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
  value3: boolean;
...
export class compoundFCM__unwindFullyCollateralisedFixedTakerSwapResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
  value3: BigInt;
...
export class compoundFCM extends ethereum.SmartContract {
  static bind(address: Address): compoundFCM {
    return new compoundFCM("compoundFCM", address);
  }
  ...
  getTraderMarginInCTokens(traderAddress: Address): BigInt {
    let result = super.call(
      "getTraderMarginInCTokens",
      "getTraderMarginInCTokens(address):(uint256)",
  ...
  getTraderWithYieldBearingAssets(
    trader: Address
  ): compoundFCM__getTraderWithYieldBearingAssetsResultTraderInfoStruct {
    let result = super.call(
      "getTraderWithYieldBearingAssets",
  ...
  initiateFullyCollateralisedFixedTakerSwap(
  ...
  ): compoundFCM__initiateFullyCollateralisedFixedTakerSwapResult {
    let result = super.call(
      "initiateFullyCollateralisedFixedTakerSwap",
    ...
    return new compoundFCM__initiateFullyCollateralisedFixedTakerSwapResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBigInt()
  ...
  > {
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new compoundFCM__initiateFullyCollateralisedFixedTakerSwapResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt(),
        value[3].toBigInt()
  ...
  traders(param0: Address): compoundFCM__tradersResult {
    let result = super.call(
      "traders",
    ...
    return new compoundFCM__tradersResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBoolean()
  ...
  try_traders(
    param0: Address
  ): ethereum.CallResult<compoundFCM__tradersResult> {
    let result = super.tryCall(
      "traders",
      "traders(address):(uint256,int256,int256,bool)",
      [ethereum.Value.fromAddress(param0)]
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new compoundFCM__tradersResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt(),
        value[3].toBoolean()
  ...
  unwindFullyCollateralisedFixedTakerSwap(
    ...
    sqrtPriceLimitX96: BigInt
  ): compoundFCM__unwindFullyCollateralisedFixedTakerSwapResult {
    let result = super.call(
      "unwindFullyCollateralisedFixedTakerSwap",
    ...
    return new compoundFCM__unwindFullyCollateralisedFixedTakerSwapResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBigInt()
  ...
  > {
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new compoundFCM__unwindFullyCollateralisedFixedTakerSwapResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt(),
        value[3].toBigInt()
