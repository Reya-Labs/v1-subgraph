...
export class RateOracle__currentBlockSlopeResult {
  value0: BigInt;
  value1: BigInt;
...
export class RateOracle__getBlockSlopeResult {
  value0: BigInt;
  value1: BigInt;
...
export class RateOracle__getLastRateSlopeResult {
  value0: BigInt;
  value1: BigInt;
...
export class RateOracle__getLastUpdatedRateResult {
  value0: BigInt;
  value1: BigInt;
...
export class RateOracle__lastUpdatedBlockResult {
  value0: BigInt;
  value1: BigInt;
...
export class RateOracle__observationsResult {
  value0: BigInt;
  value1: BigInt;
  value2: boolean;
...
export class RateOracle__oracleVarsResult {
  value0: i32;
  value1: i32;
  value2: i32;
...
export class RateOracle extends ethereum.SmartContract {
  static bind(address: Address): RateOracle {
    return new RateOracle("RateOracle", address);
  }
  ...
  currentBlockSlope(): RateOracle__currentBlockSlopeResult {
    let result = super.call(
      "currentBlockSlope",
    ...
    return new RateOracle__currentBlockSlopeResult(
      result[0].toBigInt(),
      result[1].toBigInt()
    );
  }
  ...
  try_currentBlockSlope(): ethereum.CallResult<
    RateOracle__currentBlockSlopeResult
  > {
    let result = super.tryCall(
      "currentBlockSlope",
      "currentBlockSlope():(uint32,uint256)",
    ...
    return ethereum.CallResult.fromValue(
      new RateOracle__currentBlockSlopeResult(
        value[0].toBigInt(),
        value[1].toBigInt()
      )
    );
  ...
  getBlockSlope(): RateOracle__getBlockSlopeResult {
    let result = super.call(
      "getBlockSlope",
    ...
    return new RateOracle__getBlockSlopeResult(
      result[0].toBigInt(),
      result[1].toBigInt()
    );
  }

  try_getBlockSlope(): ethereum.CallResult<RateOracle__getBlockSlopeResult> {
    let result = super.tryCall(
      "getBlockSlope",
      "getBlockSlope():(uint256,uint32)",
      []
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new RateOracle__getBlockSlopeResult(
        value[0].toBigInt(),
        value[1].toBigInt()
      )
    );
  ...
  getLastRateSlope(): RateOracle__getLastRateSlopeResult {
    let result = super.call(
      "getLastRateSlope",
    ...
    return new RateOracle__getLastRateSlopeResult(
      result[0].toBigInt(),
      result[1].toBigInt()
    );
  }
  ...
  try_getLastRateSlope(): ethereum.CallResult<
    RateOracle__getLastRateSlopeResult
  > {
    let result = super.tryCall(
      "getLastRateSlope",
      "getLastRateSlope():(uint256,uint32)",
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new RateOracle__getLastRateSlopeResult(
        value[0].toBigInt(),
        value[1].toBigInt()
      )
    );
  ...
  getLastUpdatedRate(): RateOracle__getLastUpdatedRateResult {
    let result = super.call(
      "getLastUpdatedRate",
    ...
    return new RateOracle__getLastUpdatedRateResult(
      result[0].toBigInt(),
      result[1].toBigInt()
    );
  }
  ...
  try_getLastUpdatedRate(): ethereum.CallResult<
    RateOracle__getLastUpdatedRateResult
  > {
    let result = super.tryCall(
      "getLastUpdatedRate",
      "getLastUpdatedRate():(uint32,uint256)",
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new RateOracle__getLastUpdatedRateResult(
        value[0].toBigInt(),
        value[1].toBigInt()
      )
    );
  ...
  lastUpdatedBlock(): RateOracle__lastUpdatedBlockResult {
    let result = super.call(
      "lastUpdatedBlock",
    ...
    return new RateOracle__lastUpdatedBlockResult(
      result[0].toBigInt(),
      result[1].toBigInt()
    );
  }
  ...
  try_lastUpdatedBlock(): ethereum.CallResult<
    RateOracle__lastUpdatedBlockResult
  > {
    let result = super.tryCall(
      "lastUpdatedBlock",
      "lastUpdatedBlock():(uint32,uint256)",
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new RateOracle__lastUpdatedBlockResult(
        value[0].toBigInt(),
        value[1].toBigInt()
      )
    );
  ...
  observations(param0: BigInt): RateOracle__observationsResult {
    let result = super.call(
      "observations",
    ...
    return new RateOracle__observationsResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBoolean()
    );
  ...
  try_observations(
    param0: BigInt
  ): ethereum.CallResult<RateOracle__observationsResult> {
    let result = super.tryCall(
      "observations",
      "observations(uint256):(uint32,uint216,bool)",
      [ethereum.Value.fromUnsignedBigInt(param0)]
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new RateOracle__observationsResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBoolean()
      )
  ...
  oracleVars(): RateOracle__oracleVarsResult {
    let result = super.call(
      "oracleVars",
    ...
    return new RateOracle__oracleVarsResult(
      result[0].toI32(),
      result[1].toI32(),
      result[2].toI32()
    );
  ...
  try_oracleVars(): ethereum.CallResult<RateOracle__oracleVarsResult> {
    let result = super.tryCall(
      "oracleVars",
      "oracleVars():(uint16,uint16,uint16)",
      []
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new RateOracle__oracleVarsResult(
        value[0].toI32(),
        value[1].toI32(),
        value[2].toI32()
      )
