...
export class AaveRateOracle_USDC__observationsResult {
  value0: BigInt;
  value1: BigInt;
  value2: boolean;
...
export class AaveRateOracle_USDC__oracleVarsResult {
  value0: i32;
  value1: i32;
  value2: i32;
...
export class AaveRateOracle_USDC extends ethereum.SmartContract {
  static bind(address: Address): AaveRateOracle_USDC {
    return new AaveRateOracle_USDC("AaveRateOracle_USDC", address);
  }
  ...
  observations(param0: BigInt): AaveRateOracle_USDC__observationsResult {
    let result = super.call(
      "observations",
    ...
    return new AaveRateOracle_USDC__observationsResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBoolean()
    );
  ...
  try_observations(
    param0: BigInt
  ): ethereum.CallResult<AaveRateOracle_USDC__observationsResult> {
    let result = super.tryCall(
      "observations",
      "observations(uint256):(uint32,uint216,bool)",
      [ethereum.Value.fromUnsignedBigInt(param0)]
    ...
    return ethereum.CallResult.fromValue(
      new AaveRateOracle_USDC__observationsResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBoolean()
      )
  ...
  oracleVars(): AaveRateOracle_USDC__oracleVarsResult {
    let result = super.call(
      "oracleVars",
    ...
    return new AaveRateOracle_USDC__oracleVarsResult(
      result[0].toI32(),
      result[1].toI32(),
      result[2].toI32()
    );
  ...
  try_oracleVars(): ethereum.CallResult<AaveRateOracle_USDC__oracleVarsResult> {
    let result = super.tryCall(
      "oracleVars",
      "oracleVars():(uint16,uint16,uint16)",
      []
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new AaveRateOracle_USDC__oracleVarsResult(
        value[0].toI32(),
        value[1].toI32(),
        value[2].toI32()
      )
