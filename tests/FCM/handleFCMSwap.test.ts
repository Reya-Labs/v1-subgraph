...
import { handleFCMSwap } from '../../src/mappings/FCM/index';
import { handleIrsInstanceDeployed } from '../../src/mappings/factory';

import { FullyCollateralisedSwap as aaveFullyCollateralisedSwap } from '../../generated/templates/aaveFCM/aaveFCM';
import { FullyCollateralisedSwap as compoundFullyCollateralisedSwap } from '../../generated/templates/compoundFCM/compoundFCM';
...
describe('handleFCMSwap()', () => {
  ...
  test('aaveFCM: Initialisation and Accumulation Check', () => {
    ...
    const fullyCollateralisedSwapEvent = changetype<aaveFullyCollateralisedSwap>(newMockEvent());
  ...
  test('compoundFCM: Initialisation and Accumulation Check', () => {
    ...
    // eslint-disable-next-line no-undef
    const fullyCollateralisedSwapEvent = changetype<compoundFullyCollateralisedSwap>(newMockEvent());
    const eventAddress = irsInstanceEvent.params.fcm;
    const trader = randomAddresses[1];
    const desiredNotional = BigInt.fromI32(100);
    const sqrtPriceLimitX96 = BigInt.fromI32(5);
